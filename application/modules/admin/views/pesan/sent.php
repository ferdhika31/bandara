					...
					<div class="row inbox">
						...
						<div class="col-md-10">
							<div class="inbox-header">
								<h1 class="pull-left">Kotak Terkirim</h1>
							</div>
									...
									<table class="table table-hover">
										...
										if(!empty($sent)):
											...
											foreach ($sent as $sent):
												$tanggal = substr($sent['waktu'], 0,10);
										?>
											<tr>
												<td><?php echo $index;?></td>
												<td><?php echo ucwords($sent['ke']);?></td>
												<td><?php echo ucfirst(substr($sent['pesan'], 0,30));?></td>
												<td><?php echo nama_hari($tanggal).', '.tgl_indo($tanggal);?></td>
												<td>
													<a href="<?= site_url('admin/pesan/lihat/'.$sent['index']); ?>" class="btn default btn-xs blue">
